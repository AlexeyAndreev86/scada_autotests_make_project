...
def test_equipment_IEC_101(driver):
    ...
    driver.find_element(By.XPATH, '//div[@aria-level="2"]/span[text()="IEC-101"]//preceding-sibling::div[@class="webix_tree_close webix_tree_img webix_tree_plus3"]').click()
    driver.find_element(By.XPATH, "//span[text()='IEC-101']//ancestor::div[@class='webix_tree_branch_2']//span[text()='Выкатной выключатель(DPI)']").click()
    ...
    time.sleep(0.75)
    driver.find_element(By.XPATH, '//b[text()="IEC101Master"]').click()
    time.sleep(0.75)
    driver.find_element(By.XPATH, '//b[text()="COM14"]').click()
    time.sleep(0.75)
    driver.find_element(By.XPATH, '//b[text()="FT12_3"]').click()
    time.sleep(0.75)
    ...
    driver.find_element(By.XPATH, "//span[text()='IEC-101']//ancestor::div[@class='webix_tree_branch_2']//span[text()='Выкатной выключатель']").click()
    driver.find_element(By.CSS_SELECTOR, 'button[aria-label="Уведомления об обслуживании"]').click()
    time.sleep(0.25)
    driver.find_element(By.XPATH, '//select/option[text()="Параметр"]').click()
    action = ActionChains(driver)
    ...
    time.sleep(0.1)
    driver.find_element(By.XPATH, '//span[contains(., "(RPV)")]//following-sibling::span[@title="Добавить параметр"]').click()
    time.sleep(0.1)
    driver.find_element(By.XPATH, '//div[@aria-rowindex="2" and text()="Выключатель отключен"]').click()
    time.sleep(0.1)
    driver.find_element(By.XPATH, '//span[contains(., "(RPO)")]//following-sibling::span[@title="Добавить параметр"]').click()
    time.sleep(0.1)
    ...
    driver.find_element(By.XPATH, "//span[text()='IEC-101']//ancestor::div[@class='webix_tree_branch_2']//span[text()='Измерения']").click()
    time.sleep(0.5)
    driver.find_element(By.XPATH, '//b[text()="Commands"]').click()
    ...
    print(time.asctime(), 'test_1004_equipments_IEC-101 пройден') 
    time.sleep(1)
